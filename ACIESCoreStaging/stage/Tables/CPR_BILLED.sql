CREATE TABLE [stage].[CPR_BILLED](
	...
	[InsertDate] DATETIME,
 CONSTRAINT [CN__BILLED_CPK_BILLED] PRIMARY KEY CLUSTERED 
(
	[CPK_BILLED] ASC
)
)
GO
ALTER TABLE [stage].[CPR_BILLED]
ADD CONSTRAINT [stage.CPR_BILLEDInsertDate]
