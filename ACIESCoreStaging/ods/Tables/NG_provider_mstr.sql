CREATE TABLE [ods].[NG_provider_mstr]
(
    ...
    CONSTRAINT [PKods.NG_provider_mstr.RecordID]
        PRIMARY KEY CLUSTERED ([RecordID] ASC)
) ON [PRIMARY]
GO
ALTER TABLE [ods].[NG_provider_mstr]
ADD CONSTRAINT [ods.NG_provider_mstrEffectiveDate]
    DEFAULT (GETDATE()) FOR [EffectiveDate]
GO
ALTER TABLE [ods].[NG_provider_mstr]
ADD CONSTRAINT [ods.NG_provider_mstrDeleteRowFlag]
    DEFAULT ((0)) FOR [DeleteRowFlag]
GO
ALTER TABLE [ods].[NG_provider_mstr]
ADD CONSTRAINT [ods.NG_provider_mstrInsertDate]
