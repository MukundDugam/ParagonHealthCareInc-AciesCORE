CREATE TABLE [ods].[CPR_INSCOMP](
    ...
    CONSTRAINT [PKods.CPR_INSCOMP.RecordID]
        PRIMARY KEY CLUSTERED ([RecordID] ASC)
) ON [PRIMARY]
GO
ALTER TABLE [ods].[CPR_INSCOMP]
ADD CONSTRAINT [ods.CPR_INSCOMPEffectiveDate]
    DEFAULT (GETDATE()) FOR [EffectiveDate]
GO
ALTER TABLE [ods].[CPR_INSCOMP]
ADD CONSTRAINT [ods.CPR_INSCOMPDeleteRowFlag]
    DEFAULT ((0)) FOR [DeleteRowFlag]
GO
ALTER TABLE [ods].[CPR_INSCOMP]
ADD CONSTRAINT [ods.CPR_INSCOMPInsertDate]
